...
/**
 * Xml 节点生成工具 可以参考 org.mybatis.generator.codegen.mybatis3.xmlmapper.elements.
 * AbstractXmlElementGenerator
 * 
 * @author fury
 * @date : 2017年11月17日 下午2:36:40
 */
public class XmlElementGeneratorTools {
	...
	public static void useGeneratedKeys(XmlElement element, IntrospectedTable introspectedTable, String prefix) {
		...
		if (gk != null) {
			IntrospectedColumn introspectedColumn = IntrospectedTableTools.safeGetColumn(introspectedTable,
					gk.getColumn());
	 ...
	 * @return
	 */
	private static List<TextElement> generateCommColumns(List<IntrospectedColumn> columns, String prefix,
			boolean bracket, int type) {
	 ...
	 * @return
	 */
	private static XmlElement generateCommColumnsSelective(List<IntrospectedColumn> columns, String prefix,
			boolean bracket, int type) {
		...
		for (IntrospectedColumn introspectedColumn : columns) {
			...
			case 3:
				...
				break;
			case 2:
				eleIf.addElement(new TextElement(
						MyBatis3FormattingUtilities.getParameterClause(introspectedColumn, prefix) + ","));
				break;
			case 1:
				eleIf.addElement(
